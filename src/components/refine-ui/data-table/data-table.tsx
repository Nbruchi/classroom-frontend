        ...
        const checkOverflow = () => {
            if (tableRef.current && tableContainerRef.current) {
                ...
                const horizontalOverflow =
                    table.offsetWidth > container.clientWidth;
                const verticalOverflow =
                    table.offsetHeight > container.clientHeight;
...
export function getCommonStyles<TData>({
    ...
    return {
        ...
        background:
            isOverflowing.horizontal && isPinned ? "var(--background)" : "",
